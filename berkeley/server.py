...
# Master thread function to accept client connections
def startConnecting(master_server):
    # Fetch clock time from slave clients
    while True:
...
# Subroutine function to calculate average clock difference
...
# Master synchronization thread function to synchronize all clocks
